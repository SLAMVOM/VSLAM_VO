    ...
    public:
        ...
        virtual void oplusImpl(const double *update) override {
            ...
            update_eigen << update[0], update[1], update[2], update[3], update[4],
                update[5];  // first three are for translation, last three are for rotation
...
/// unary edge that only estimates poses
class EdgeProjectionPoseOnly : public g2o::BaseUnaryEdge<2, Vec2, VertexPose> {
    public:
        ...
        virtual void computeError() override {
            ...
            pos_pixel /= pos_pixel[2]; // convert to pixel coordinate
        ...
        virtual void linearizeOplus() override {
            ...
            _jacobianOplusXi << -fx * Zinv, 0, fx * X * Zinv2, fx * X * Y * Zinv2, -fx - fx * X * X * Zinv2, fx * Y * Zinv, 
                0, -fy * Zinv, fy * Y * Zinv2, fy + fy * Y * Y * Zinv2, -fy * X * Y * Zinv2, -fy * X * Zinv; // [2 x 6]
        }
...
class EdgeProjection : public g2o::BaseBinaryEdge<2, Vec2, VertexPose, VertexXYZ> {
    public:
        ...
        /// pass in camera intrinsics during construction
